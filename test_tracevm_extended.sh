...
java -cp ./classes:tracer.jar:lib/javassist.jar ist.meic.pa.TraceVMExtended Test4 10 &>  test4.out;
java -cp ./classes:tracer.jar:lib/javassist.jar ist.meic.pa.TraceVMExtended Test5 &>  test5.out;
java -cp ./classes:tracer.jar:lib/javassist.jar ist.meic.pa.TraceVMExtended Test6 &>  test6.out;
java -cp ./classes:tracer.jar:lib/javassist.jar ist.meic.pa.TraceVMExtended Test7 &>  test7.out;
java -cp ./classes:tracer.jar:lib/javassist.jar ist.meic.pa.TraceVMExtended Test8 &>  test8.out;
